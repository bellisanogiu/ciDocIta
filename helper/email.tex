...
\verb|send_email('recipient', 'subject', 'message')| invia una email utilizzando la funzione nativa \ac{PHP} \var{mail()}. Per funzionalità più potenti comunque si rimanda alla classe Email\vpageref{class:email}.