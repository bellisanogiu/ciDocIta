...
Si crei il file chiamato \fil{smileys.php} nella directory \sys{/application/controllers/} e si inserisca il codice descritto in seguito. Si modifichi nella funzione \verb|get_clickable_smileys()| l'URL in modo che punti alla directory degli smiley. L'esempio utilizza anche la classe Table:
