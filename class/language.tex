...
I file linguaggio sono generalmente memorizzati nella directory \sys{/system/language}. In alternativa è possibile creare una cartella denominata \var{language} all'interno della cartella \var{application} e memorizzare al suo interno i propri file. CodeIgniter cercherà prima nella directory \sys{/system/language}: se la directory non esiste oppure se la lingua specificata non si trova in quel percorso, allora CI effettuerà una nuova ricerca nella cartella \sys{/system/language}.
