...
Qui di seguito si mostra un codice di una query standard con risultati multipli (versione Object). La funzione \var{resul()} restituisce un array di oggetti. Esempio \var{\$row->title}.
...
Le query standard con risultati multipli, ma che utilizza l'array per i propri dati, prevede una sintassi leggermente differente. In questo caso la funzione \verb|result_array()| restituisce un array di indici di array, come per esempio \var{\$row['title']}:
