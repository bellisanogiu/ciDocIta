...
Se al momento si invia il modulo, il form verrà caricato nuovamente: questo avviene perché non si è ancora stabilita alcuna regola di convalida. Infatti, poiché la classe Form Validation non sa come comportarsi, questa restituisce FALSE per impostazione predefinita. La funzione \var{run()} restituisce TRUE solo se le regole sono state rispettate senza alcuna eccezione.
