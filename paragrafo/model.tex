...
La nuova istruzione introdotta è \verb|$this->load->database()| che si occupa di caricare il database i cui parametri sono memorizzati nel file \fil{database.php} nel percorso \sys{/application/config/} (si veda la sezione\vref{sec:accessodb}).
