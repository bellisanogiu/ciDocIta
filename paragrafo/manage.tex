%************************************************
\chapter{Gestire le applicazioni}
\label{cap:manage}
%************************************************
Per impostazione predefinita CodeIgniter gestisce solo un progetto alla volta, realizzato nel percorso \sys{/application/}. A volte però lo sviluppatore deve gestire diversi progetti contemporaneamente con una sola installazione del framework; in questo caso si può optare per rinominare o spostare la cartella \sys{/application/}.
...
Ogni applicazione ha bisogno del file \fil{index.php} che richiama il progetto associato.