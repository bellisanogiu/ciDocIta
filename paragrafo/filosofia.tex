...
Nota: Per impostazione predefinita, il file \fil{index.php} è incluso nell'\ac{URL}, ma può essere rimosso utilizzando semplicemente un file \fil{.htaccess} (vedi capitolo\vref{cap:sicurezza}).
