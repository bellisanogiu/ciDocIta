...
Nota: Per impostazione predefinita, la stringa \fil{index.php} è sempre presente nell'\ac{URL}. Questa può comunque essere rimossa agendo semplicemente sul file \fil{.htaccess} (vedi capitolo\vref{sec:index}).
